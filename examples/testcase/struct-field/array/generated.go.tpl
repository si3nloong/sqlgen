...
func (v Array) GetID() sequel.ColumnValuer[uint64] {
	return sequel.Column("id", v.ID, func(vi uint64) driver.Value { return int64(vi) })
}
func (v Array) GetBoolList() sequel.ColumnValuer[[]bool] {
	return sequel.Column("bool_list", v.BoolList, func(vi []bool) driver.Value { return encoding.MarshalBoolList(vi) })
}
func (v Array) GetStrList() sequel.ColumnValuer[[]string] {
	return sequel.Column("str_list", v.StrList, func(vi []string) driver.Value { return encoding.MarshalStringList(vi) })
}
func (v Array) GetCustomStrList() sequel.ColumnValuer[[]customStr] {
	return sequel.Column("custom_str_list", v.CustomStrList, func(vi []customStr) driver.Value { return encoding.MarshalStringList(vi) })
}
func (v Array) GetIntList() sequel.ColumnValuer[[]int] {
	return sequel.Column("int_list", v.IntList, func(vi []int) driver.Value { return encoding.MarshalSignedIntList(vi) })
}
func (v Array) GetInt8List() sequel.ColumnValuer[[]int8] {
	return sequel.Column("int_8_list", v.Int8List, func(vi []int8) driver.Value { return encoding.MarshalSignedIntList(vi) })
}
func (v Array) GetInt16List() sequel.ColumnValuer[[]int16] {
	return sequel.Column("int_16_list", v.Int16List, func(vi []int16) driver.Value { return encoding.MarshalSignedIntList(vi) })
}
func (v Array) GetInt32List() sequel.ColumnValuer[[]int32] {
	return sequel.Column("int_32_list", v.Int32List, func(vi []int32) driver.Value { return encoding.MarshalSignedIntList(vi) })
}
func (v Array) GetInt64List() sequel.ColumnValuer[[]int64] {
	return sequel.Column("int_64_list", v.Int64List, func(vi []int64) driver.Value { return encoding.MarshalSignedIntList(vi) })
}
func (v Array) GetUintList() sequel.ColumnValuer[[]uint] {
	return sequel.Column("uint_list", v.UintList, func(vi []uint) driver.Value { return encoding.MarshalUnsignedIntList(vi) })
}
func (v Array) GetUint8List() sequel.ColumnValuer[[]uint8] {
	return sequel.Column("uint_8_list", v.Uint8List, func(vi []uint8) driver.Value { return encoding.MarshalUnsignedIntList(vi) })
}
func (v Array) GetUint16List() sequel.ColumnValuer[[]uint16] {
	return sequel.Column("uint_16_list", v.Uint16List, func(vi []uint16) driver.Value { return encoding.MarshalUnsignedIntList(vi) })
}
func (v Array) GetUint32List() sequel.ColumnValuer[[]uint32] {
	return sequel.Column("uint_32_list", v.Uint32List, func(vi []uint32) driver.Value { return encoding.MarshalUnsignedIntList(vi) })
}
func (v Array) GetUint64List() sequel.ColumnValuer[[]uint64] {
	return sequel.Column("uint_64_list", v.Uint64List, func(vi []uint64) driver.Value { return encoding.MarshalUnsignedIntList(vi) })
}
func (v Array) GetF32List() sequel.ColumnValuer[[]float32] {
	return sequel.Column("f_32_list", v.F32List, func(vi []float32) driver.Value { return encoding.MarshalFloatList(vi) })
}
func (v Array) GetF64List() sequel.ColumnValuer[[]float64] {
	return sequel.Column("f_64_list", v.F64List, func(vi []float64) driver.Value { return encoding.MarshalFloatList(vi) })
}
