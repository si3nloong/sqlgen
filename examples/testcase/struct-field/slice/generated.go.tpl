...
func (v Slice) CreateTableStmt() string {
	return "CREATE TABLE IF NOT EXISTS `slice` (`id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,`bool_list` JSON NOT NULL,`str_list` JSON NOT NULL,`custom_str_list` JSON NOT NULL,`int_list` JSON NOT NULL,`int_8_list` JSON NOT NULL,`int_16_list` JSON NOT NULL,`int_32_list` JSON NOT NULL,`int_64_list` JSON NOT NULL,`uint_list` JSON NOT NULL,`uint_8_list` JSON NOT NULL,`uint_16_list` JSON NOT NULL,`uint_32_list` JSON NOT NULL,`uint_64_list` JSON NOT NULL,`f_32_list` JSON NOT NULL,`f_64_list` JSON NOT NULL,PRIMARY KEY (`id`));"
}
func (Slice) TableName() string {
	return "slice"
}
func (Slice) InsertOneStmt() string {
	return "INSERT INTO slice (bool_list,str_list,custom_str_list,int_list,int_8_list,int_16_list,int_32_list,int_64_list,uint_list,uint_8_list,uint_16_list,uint_32_list,uint_64_list,f_32_list,f_64_list) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);"
}
func (Slice) InsertVarQuery() string {
	return "(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
}
...
func (v Slice) PK() (columnName string, pos int, value driver.Value) {
	return "id", 0, int64(v.ID)
}
func (Slice) FindByPKStmt() string {
	return "SELECT id,bool_list,str_list,custom_str_list,int_list,int_8_list,int_16_list,int_32_list,int_64_list,uint_list,uint_8_list,uint_16_list,uint_32_list,uint_64_list,f_32_list,f_64_list FROM slice WHERE id = ? LIMIT 1;"
}
func (Slice) UpdateByPKStmt() string {
	return "UPDATE slice SET bool_list = ?,str_list = ?,custom_str_list = ?,int_list = ?,int_8_list = ?,int_16_list = ?,int_32_list = ?,int_64_list = ?,uint_list = ?,uint_8_list = ?,uint_16_list = ?,uint_32_list = ?,uint_64_list = ?,f_32_list = ?,f_64_list = ? WHERE id = ? LIMIT 1;"
}
