...
func (AutoPkLocation) Columns() []string {
	return []string{"id", "geo_point", "ptr_date"}
}
func (AutoPkLocation) SQLColumns() []string {
	return []string{"id", "ST_AsBinary(geo_point, 4326)", "ptr_date"}
}
func (v AutoPkLocation) Values() []any {
	return []any{(int64)(v.ID), ewkb.Value(v.GeoPoint, 4326), types.TextMarshaler(v.PtrDate)}
}
func (v *AutoPkLocation) Addrs() []any {
	...
	addrs[2] = types.TextUnmarshaler(v.PtrDate)
	return addrs
}
...
func (v AutoPkLocation) InsertOneStmt() (string, []any) {
	return "INSERT INTO auto_pk_location (geo_point,ptr_date) VALUES (ST_GeomFromEWKB(?),?);", []any{ewkb.Value(v.GeoPoint, 4326), types.TextMarshaler(v.PtrDate)}
}
func (v AutoPkLocation) FindOneByPKStmt() (string, []any) {
	return "SELECT id,ST_AsBinary(geo_point, 4326),ptr_date FROM auto_pk_location WHERE id = ? LIMIT 1;", []any{(int64)(v.ID)}
}
func (v AutoPkLocation) UpdateOneByPKStmt() (string, []any) {
	return "UPDATE auto_pk_location SET geo_point = ST_GeomFromEWKB(?),ptr_date = ? WHERE id = ?;", []any{ewkb.Value(v.GeoPoint, 4326), types.TextMarshaler(v.PtrDate), (int64)(v.ID)}
}
