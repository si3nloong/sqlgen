...
func (v Address) GetLine2() sequel.ColumnValuer[string] {
	return sequel.Column("line_2", v.Line2, func(val string) driver.Value { return string(val) })
}
func (v Address) GetCountryCode() sequel.ColumnValuer[string] {
	return sequel.Column("country_code", v.CountryCode, func(val string) driver.Value { return string(val) })
}
...
func (v HouseUnit) Values() []any {
	return []any{int64(v.No), time.Time(v.BuildTime), types.JSONMarshaler(v.Address), int64(v.Kind), int64(v.Type), int64(v.Chan), types.JSONMarshaler(v.Inner), types.JSONMarshaler(v.Arr), encoding.MarshalFloatList(v.Slice), types.JSONMarshaler(v.Map)}
}
...
func (v HouseUnit) GetNo() sequel.ColumnValuer[uint] {
	return sequel.Column("no", v.No, func(val uint) driver.Value { return int64(val) })
}
func (v HouseUnit) GetBuildTime() sequel.ColumnValuer[time.Time] {
	return sequel.Column("build_time", v.BuildTime, func(val time.Time) driver.Value { return time.Time(val) })
}
func (v HouseUnit) GetAddress() sequel.ColumnValuer[Address] {
	return sequel.Column("address", v.Address, func(val Address) driver.Value { return types.JSONMarshaler(val) })
}
func (v HouseUnit) GetKind() sequel.ColumnValuer[reflect.Kind] {
	return sequel.Column("kind", v.Kind, func(val reflect.Kind) driver.Value { return int64(val) })
}
func (v HouseUnit) GetType() sequel.ColumnValuer[HouseUnitType] {
	return sequel.Column("type", v.Type, func(val HouseUnitType) driver.Value { return int64(val) })
}
func (v HouseUnit) GetChan() sequel.ColumnValuer[reflect.ChanDir] {
	return sequel.Column("chan", v.Chan, func(val reflect.ChanDir) driver.Value { return int64(val) })
}
func (v HouseUnit) GetInner() sequel.ColumnValuer[struct{ Flag bool }] {
	return sequel.Column("inner", v.Inner, func(val struct{ Flag bool }) driver.Value { return types.JSONMarshaler(val) })
}
func (v HouseUnit) GetArr() sequel.ColumnValuer[[2]string] {
	return sequel.Column("arr", v.Arr, func(val [2]string) driver.Value { return types.JSONMarshaler(val) })
}
func (v HouseUnit) GetSlice() sequel.ColumnValuer[[]float64] {
	return sequel.Column("slice", v.Slice, func(val []float64) driver.Value { return encoding.MarshalFloatList(val) })
}
func (v HouseUnit) GetMap() sequel.ColumnValuer[map[string]float64] {
	return sequel.Column("map", v.Map, func(val map[string]float64) driver.Value { return types.JSONMarshaler(val) })
}
