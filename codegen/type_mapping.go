...
var (
	typeMap = map[string]*Mapping{
		...
		"cloud.google.com/go/civil.Date": {"github.com/si3nloong/sqlgen/sequel/types.TextMarshaler(%v)", "github.com/si3nloong/sqlgen/sequel/types.Date(%v)"},
		"sql.RawBytes":                   {"database/sql.RawBytes(%v)", "(*database/sql.RawBytes)(%v)"},
